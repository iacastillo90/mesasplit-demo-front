...
Todas las requirements anteriores son ADDED para la capability `waiter-order-draft-cart`: `dynamic-add-remove`, `qty-controls`, `aggregation-semantics`, `client-cart-consistency`. No hay requirements MODIFIED ni REMOVED.
