// src/features/KdsView/components/KdsHeader.jsx — cabecera KDS de cocina (kds-kitchen)
// Cabecera superior en modo oscuro con métricas en vivo y disparadores de los modales de Recall y Lista 86.
...
export default function KdsHeader({ activeCount, recallCount, onOpenRecall, onOpenLista86 }) {
  return (
    ...
    <header className="flex flex-wrap items-center justify-between border-b border-brand-800/60 px-6 py-4 gap-4">
      ...
      {/* Acciones de la cabecera: indicador de tickets, botón Lista 86 y botón Recall. */}
