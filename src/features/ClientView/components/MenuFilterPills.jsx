...
export default function MenuFilterPills({ activeFilter = 'all', onSelectFilter }) {
  return (
    ...
    <div className="flex items-center gap-2 overflow-x-auto pb-2 pt-1 scrollbar-none whitespace-nowrap px-1 max-w-full touch-pan-x">
      {DIET_FILTERS.map((f) => {
        ...
        return (
          <button
            ...
            className={`flex items-center gap-1.5 rounded-full px-3.5 py-1.5 text-xs font-bold whitespace-nowrap transition-all duration-200 active:scale-95 border cursor-pointer ${
              isActive
