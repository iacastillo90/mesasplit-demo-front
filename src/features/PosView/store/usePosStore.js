// src/features/PosView/store/usePosStore.js — store de Caja POS (pos-cashier)
// Slice de estado de PosView: bloqueo de sesión con PIN, cuentas abiertas, medio de pago,
// emisión de DTEs, arqueo de Cierre Ciego e integración con el bus en tiempo real (payment.qr_received).
...
export const usePosStore = create((set, get) => ({
  ...
  // Restablece el slice a su estado inicial para tests.
